...
public:
    ...
    /**
     * @brief [Blocking] Initialize teleoperation robots
     ...
     * fault, both local and remote robots will release brakes, and becomes operational a few
     * seconds later.
     ...
     * following conditions to be met: enabled, brakes fully released, in auto-remote mode, no
     ...
     * remote still by releasing the pedal, while the local can drag freely. When the local reaches
     * an appropriate pose, press down the pedal and the remote will follow the local again.
    ...
    /**
     * @brief [Non-blocking] Set maximum wrench for the remote robot. The controller will regulate
     * its output to maintain contact wrench (force and moment) with the environment under the set
     * values.
