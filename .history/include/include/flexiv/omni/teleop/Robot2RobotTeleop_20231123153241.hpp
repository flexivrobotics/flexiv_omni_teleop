...
public:
  ...
  /**
   * @brief [Blocking] First, the remote robot will go to the home pose, and then the local will go
   * to the same pose as the remote
  ...
  /**
   * @brief [Blocking/Non-blocking] Run teleoperation. The remote will always maintain the same pose
   * as the local while the user operates the local.
