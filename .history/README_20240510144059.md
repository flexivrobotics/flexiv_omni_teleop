...
2. Clone the code and run the generator ``flexiv_omni_teleop/omni_license/generator `` on your computer to generate your feature ID and provide the feature_id.txt to Flexiv to apply for the license.
