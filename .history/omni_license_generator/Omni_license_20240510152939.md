...
3. Run the generator under ``flexiv_omni_teleop/omni_license_generator`` on your computer.
   ...
   Note: The feature id is a unique identifier for your application and is bound to your computer. You cannot run Omni-Teleop on other devices. Please generate feature_id and use Omni license on the same computer.
