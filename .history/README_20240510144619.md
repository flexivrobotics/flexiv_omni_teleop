...
2. Clone the code and run the generator ``flexiv_omni_teleop/omni_license_generator/generator `` on your computer to generate your feature ID and this will generate a feature_id.txt. Send this file to Flexiv to apply for the Omni license.
