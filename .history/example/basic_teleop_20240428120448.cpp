...
void periodicConsoleTask(flexiv::omni::teleop::Robot2RobotTeleop& teleop)
{
    ...
    while (!g_stop_sched) {
        ...
        std::cout << (" Axis [X] in "
                      << flexiv::omni::teleop::CoordTypeStr[cmd.coord]
                      << "  frame locking status :  " << cmd.trans_axis_lock_list_[0])
                  << std::endl;
        std::cout << (" Axis [Y] in  "
                      << flexiv::omni::teleop::CoordTypeStr[cmd.coord]
                      << "  frame locking status :  " flexiv::omni::teleop::CoordTypeStr[cmd.coord]
                      << cmd.trans_axis_lock_list_[1])
                  << std::endl;
        std::cout << (" Axis [Z] in  "
                      << flexiv::omni::teleop::CoordTypeStr[cmd.coord]
                      << " frame locking status :  " flexiv::omni::teleop::CoordTypeStr[cmd.coord]
                      << cmd.trans_axis_lock_list_[2])
                  << std::endl;
        std::cout << (" Axis [Rx] in  "
                      << flexiv::omni::teleop::CoordTypeStr[cmd.coord]
                      << " frame locking status :  " flexiv::omni::teleop::CoordTypeStr[cmd.coord]
                      << cmd.ori_axis_lock_list_[0])
                  << std::endl;
        std::cout << (" Axis [Ry] in  "
                      << flexiv::omni::teleop::CoordTypeStr[cmd.coord]
                      << " frame locking status :  " flexiv::omni::teleop::CoordTypeStr[cmd.coord]
                      << cmd.ori_axis_lock_list_[1])
                  << std::endl;
        std::cout << (" Axis [Rz] in  "
                      << flexiv::omni::teleop::CoordTypeStr[cmd.coord]
                      << " frame locking status :  " flexiv::omni::teleop::CoordTypeStr[cmd.coord]
                      << cmd.ori_axis_lock_list_[2])
                  << std::endl;
    }
    return;
}
