...
void printHelp()
{
    ...
    std::cout<<"     -l     [necessary] serial number of local robot in first group."<<std::endl;
    std::cout<<"     -r     [necessary] serial number of remote robot in first group."<<std::endl;
    std::cout<<"     -m     [necessary] serial number of local robot in second group."<<std::endl;
    std::cout<<"     -n     [necessary] serial number of remote robot in second group."<<std::endl;
...
struct option k_longOptions[] = {
    // clang-format off
    {"local SN of first group",                required_argument,  0, 'l'},
    {"remote SN of first group",               required_argument,  0, 'r'},
    {"local SN of second group",               required_argument,  0, 'm'},
    {"remote SN of second group",              required_argument,  0, 'n'},
    ...
    flexiv::omni::teleop::Robot2RobotTeleop& teleop2)
{
    ...
    try {
        ...
        if (!teleop1.isOperational() || !teleop2.isOperational()) {
...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        scheduler.AddTask(
            std::bind(&periodicTeleopTask, std::ref(teleop_left), std::ref(teleop_right)),
