...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        try {
            ...
            // Run teleop
            std::cout << ("Omni-Teleop will run in background ... ");
